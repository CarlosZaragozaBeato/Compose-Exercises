...
import com.example.weatherapp.feature_weather.presentation.screens.day.components.HourRowComponent
...
@Composable
fun DayScreen(country: String?, viewModel: DayViewModel = hiltViewModel()){
    ...
    if(data.value.data == null){
        LinearProgressIndicator()
            ...
            Column (
                ...
                HourRowComponent(item = data.value.data!!)
            }
            }
    }
}
